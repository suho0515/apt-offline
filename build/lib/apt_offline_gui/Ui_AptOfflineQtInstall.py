...
class Ui_AptOfflineQtInstall(object):
    ...
    def retranslateUi(self, AptOfflineQtInstall):
        ...
        self.zipFilePath.setToolTip(_translate("AptOfflineQtInstall", "Path to apt-offline data file/dir"))
        ...
        self.bugReportsButton.setToolTip(_translate("AptOfflineQtInstall", "Offline Bug Reports"))
        self.bugReportsButton.setText(_translate("AptOfflineQtInstall", "Bug Reports"))
        self.browseFileFoldercheckBox.setToolTip(_translate("AptOfflineQtInstall", "Check to enable apt-offline data directory"))
